...
f=paste0(ROOTDIR, "/nanocompore_pipelines/METTL3_KD_polyA/results/nanocompore/out_sig_sites_GMM_logit_pvalue_thr_0.05.bed")
...
pdf(paste0(ROOTDIR,"/profiles/METTL3_polyA/results/mRNA_profile.pdf"))
